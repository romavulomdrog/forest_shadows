...
public class NVScreenShot : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            string filename = string.Format("{0}/screenshot/{1}_{2}.png", System.IO.Directory.GetCurrentDirectory(), nameScreenshotSt, Random.Range(1000, 9999999));
