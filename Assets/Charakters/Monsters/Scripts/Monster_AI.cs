...
public class Monster_AI : MonoBehaviour {
    ...
    [HideInInspector]
    public float speedChAnimator = 1;
    [HideInInspector]
    public int targetCurrentState;

    float rotationSpeedchange = 1;
    float speedRand = 1;
    ...
    void Update()
    {
        ...
        if (staticPosition == false)
        {
            ...
            ChControl.Move(tr.TransformDirection(new Vector3(0, -gravity * timeDelta, movementSpeed * speedchange * speedRand * speedChAnimator * timeDelta)));
        }
    ...
    IEnumerator AI_Core()
    {
        while (true)
        {
            ...
            if (Physics.CheckSphere(trPosition, targetDistance, targetLayerMask) && ignoreTarget == false)
            {
                //----
