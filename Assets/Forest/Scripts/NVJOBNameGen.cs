...
public static class NVJOBNameGen
{
    ...
    public static string GiveAName(int type, bool transfer)
    {
        //--------------
        ...
        if (type > 0)
        {
            if (type <= 4)  //  Normal English Names ---------------------------
            {
                ...
                if (transfer == false) nameFinal = firstName[Random.Range(0, firstName.Length)] + " " + secondName[Random.Range(0, secondName.Length)];
                else nameFinal = firstName[Random.Range(0, firstName.Length)] + "\n" + secondName[Random.Range(0, secondName.Length)];
            }
